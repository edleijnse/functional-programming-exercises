 ...
 */
public class M02V004_E {

  private static final BiConsumer<Stack<Integer>, IntBinaryOperator> EXECUTE = (stack, operator) -> {
    int right = stack.pop();
    int left = stack.pop();
